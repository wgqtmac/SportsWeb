<%@ Page Title="" Language="C#" MasterPageFile="~/LoginMaster.Master" AutoEventWireup="true" CodeBehind="LoginVenueManager.aspx.cs" Inherits="TheSportsWeb.LoginVenueManager" %>
    ...
    <div>
        <table class="tb">
            ...
            <asp:Repeater ID="repInfos" runat="server">
                <ItemTemplate>
                    <tr>
                        <td><%#suoshufenlei( Eval ("pId").ToString ()) %></td>
                        <td><%#Eval("pName") %></td>
                        <td>
                            <asp:LinkButton ID="lbtnDel" runat="server" CommandArgument='<%#Eval("pId") %>' OnClientClick="return confirm('确定要删除该条新闻吗？')" OnClick="lbtnDel_Click"> 删除</asp:LinkButton></td>
                    </tr>
