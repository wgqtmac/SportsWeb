...
{
    public partial class LoginTeacherManager : System.Web.UI.Page
    {
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            if (b)
            {
                ...
                fenye(1);
                DDLnews.Text = "1";
                Page.ClientScript.RegisterStartupScript(Page.GetType(), "message", "<script language='javascript' defer>alert('教师信息删除成功！');</script>");
            }
            else
            {
                Page.ClientScript.RegisterStartupScript(Page.GetType(), "message", "<script language='javascript' defer>alert('未知原因导致教师信息删除失败！');</script>");
            }
        }
