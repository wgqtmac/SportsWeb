<%@ Page Title="" Language="C#" MasterPageFile="~/common1.Master" AutoEventWireup="true" CodeBehind="sportsTeam.aspx.cs" Inherits="TheSportsWeb.sportsTeam" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CaContent" runat="server">
    <asp:Repeater runat="server" ID="sports_team">
        <ItemTemplate>
...
<asp:Content ID="Content6" ContentPlaceHolderID="content" runat="server">
    <iframe id="inweb" width="100%" scrolling="auto" height="600" frameborder="0" src="inweb.aspx?commonType=1021" name="inweb"></iframe>
</asp:Content>
