<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_alterCommon.aspx.cs" Inherits="TheSportsWeb.Login_alterCommon" %>
...
<body>
    ...
    <form id="form1" runat="server">
      ...
      <asp:DropDownList ID ="ddlCategory" runat="server" > 
            ...
            <p>顶栏标题：<asp:TextBox ID="txtTitle" runat="server" ReadOnly="true"></asp:TextBox></p>
            <p>
                顶栏内容：<FCKeditorV2:FCKeditor ID="fckContent" runat="server" Width="600px" Height="400px"></FCKeditorV2:FCKeditor>
            </p>
