<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageCommon.aspx.cs" Inherits="TheSportsWeb.login.manageCommon" %>
      ...
      <div class="m_content">
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="一级栏目标题">
                  ...
                  <asp:TemplateField HeaderText="编辑" ShowHeader="False">
                      <ItemTemplate>
                          <%--<asp:Button ID="Button1" runat="server" CausesValidation="False" 
                              ...
                              <a href='alterCommon.aspx?commonId=<%#Eval ("id") %>' target="_self">编辑</a>
