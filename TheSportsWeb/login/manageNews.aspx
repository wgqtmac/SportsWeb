<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageNews.aspx.cs" Inherits="TheSportsWeb.login.manageNews" %>
                  ...
                  <asp:TemplateField HeaderText="编辑 删除" ShowHeader="False">
                      <ItemTemplate>
                          <%--<asp:Button ID="Button1" runat="server" CausesValidation="False" 
                              ...
                              <a href='alterNews.aspx?newsId=<%#Eval ("id") %>' target="_self">编辑</a>
