...
{
    public partial class LoginVenueManager : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = new VenueManager().SelectAllVenue();
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            bool b = new VenueManager().Delete(id);
            if (b)
            {
                //重新绑定文章
                fenye(1);
        ...
        {
            string venueId = (new VenueManager().SelectVenueById(id)).VenueId ;
            string commonSonName= (new commonSonManager().SelectCommonSonById(venueId)).Title;
