<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="TheSportsWeb.search" %>
    ...
    <form id="form1" runat="server">
        ...
        <img  src="imgs/header-img.png"style="float:right;">
            ...
            <div class="s-content">
                ...
                <div class="s-fright1">
                    <p class="frightp">您当前所在的位置是 : 华北电力大学——体育教学部——<span style="color: #000;">搜索界面</span></p>
                    <div class="new">
                        ...
                        <div class="main-list">
                            ...
                            <ul class="new-ul">
                                <asp:Repeater ID="newsList" runat="server">
                                    <ItemTemplate>
                                        <li><a href="newsDetails.aspx?newsType=<%# DataBinder.Eval(Container.DataItem, "id")%>"><%# DataBinder.Eval(Container.DataItem, "title")%></a>   <span><%#Eval("createTime").ToString ().Substring (0,10)%></span></li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
                        </div>
